namespace KOLEGIO
{
    partial class frmEstablecimientosEdicion
    {
        /// <summary>
        ...
        {
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(frmEstablecimientosEdicion));
			...
			this.gbRegentes = new System.Windows.Forms.GroupBox();
			this.panel5 = new System.Windows.Forms.Panel();
			this.toolStrip3 = new System.Windows.Forms.ToolStrip();
			this.btnNuevoRegente = new System.Windows.Forms.ToolStripButton();
			this.btnEliminarRegente = new System.Windows.Forms.ToolStripButton();
			this.btnAjustarCol = new System.Windows.Forms.ToolStripButton();
			this.dgvRegentes = new System.Windows.Forms.DataGridView();
			this.colCodigoRegente = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.headerRegentes = new System.Windows.Forms.Panel();
			this.label32 = new System.Windows.Forms.Label();
			this.txtNumRegistro = new Framework.UserControls.txtNormal();
			this.label7 = new System.Windows.Forms.Label();
			this.label8 = new System.Windows.Forms.Label();
			this.txtNumInscripcion = new Framework.UserControls.txtNormal();
			...
			this.txtRepresentante = new Framework.UserControls.txtNormal();
			this.label13 = new System.Windows.Forms.Label();
			this.rtbActividades = new Framework.UserControls.rtbSaseg();
			...
			this.headerInformes = new System.Windows.Forms.Panel();
			...
			this.btnAjustarInf = new System.Windows.Forms.ToolStripButton();
			...
			this.colNumeroColeInformes = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.colNumCole = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.colNombreColeInformes = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.lblHastaTemporal = new System.Windows.Forms.Label();
			this.lblDesdeTemporal = new System.Windows.Forms.Label();
			this.dtpDesdeTemporal1 = new System.Windows.Forms.DateTimePicker();
			this.dtpHastaTemporal1 = new System.Windows.Forms.DateTimePicker();
			this.tpVisitasF = new System.Windows.Forms.TabPage();
			this.headerVisitas = new System.Windows.Forms.Panel();
			...
			this.btnAjustarVist = new System.Windows.Forms.ToolStripButton();
			...
			this.colIdColeVisitas = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.colNumeroColeVisitas = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.colNombreColeVisitas = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.txtCoordenadaN = new Framework.UserControls.txtNormal();
			this.txtCoordenadaW = new Framework.UserControls.txtNormal();
			...
			this.txtCVO = new Framework.UserControls.txtNormal();
			this.dtpVencimientoCVO = new Framework.UserControls.dtpSaseg();
			this.label28 = new System.Windows.Forms.Label();
			this.label29 = new System.Windows.Forms.Label();
			this.txtPFMS = new Framework.UserControls.txtNormal();
			this.dtpVencimientoPFMS = new Framework.UserControls.dtpSaseg();
			...
			// tabControl
			// 
			this.tabControl.Controls.Add(this.tpHorarios);
			this.tabControl.Controls.Add(this.tpCategorias);
			this.tabControl.Controls.Add(this.tpRegentes);
			this.tabControl.Controls.Add(this.tpInformes);
			this.tabControl.Controls.Add(this.tpVisitasF);
			this.tabControl.Size = new System.Drawing.Size(740, 611);
			this.tabControl.Controls.SetChildIndex(this.tpVisitasF, 0);
			this.tabControl.Controls.SetChildIndex(this.tpInformes, 0);
			this.tabControl.Controls.SetChildIndex(this.tpRegentes, 0);
			this.tabControl.Controls.SetChildIndex(this.tpCategorias, 0);
			this.tabControl.Controls.SetChildIndex(this.tpAdjuntos, 0);
			this.tabControl.Controls.SetChildIndex(this.tpAdmin, 0);
			this.tabControl.Controls.SetChildIndex(this.tpHorarios, 0);
			this.tabControl.Controls.SetChildIndex(this.tpBasicos, 0);
			// 
			// tpBasicos
			// 
			this.tpBasicos.Controls.Add(this.dtpFechaCanon);
			this.tpBasicos.Controls.Add(this.label33);
			this.tpBasicos.Controls.Add(this.label29);
			this.tpBasicos.Controls.Add(this.txtPFMS);
			this.tpBasicos.Controls.Add(this.dtpVencimientoPFMS);
			this.tpBasicos.Controls.Add(this.label30);
			this.tpBasicos.Controls.Add(this.label27);
			this.tpBasicos.Controls.Add(this.txtCVO);
			this.tpBasicos.Controls.Add(this.dtpVencimientoCVO);
			this.tpBasicos.Controls.Add(this.label28);
			this.tpBasicos.Controls.Add(this.groupBox3);
			this.tpBasicos.Controls.Add(this.dtpHastaTemporal1);
			this.tpBasicos.Controls.Add(this.dtpDesdeTemporal1);
			this.tpBasicos.Controls.Add(this.lblDesdeTemporal);
			this.tpBasicos.Controls.Add(this.lblHastaTemporal);
			...
			this.tpBasicos.Controls.Add(this.rtbActividades);
			this.tpBasicos.Controls.Add(this.label13);
			this.tpBasicos.Controls.Add(this.label11);
			this.tpBasicos.Controls.Add(this.txtRepresentante);
			...
			this.tpBasicos.Controls.Add(this.txtNumInscripcion);
			this.tpBasicos.Controls.Add(this.label7);
			this.tpBasicos.Controls.Add(this.txtNumRegistro);
			this.tpBasicos.Size = new System.Drawing.Size(732, 585);
			this.tpBasicos.Controls.SetChildIndex(this.panelBasicos, 0);
			this.tpBasicos.Controls.SetChildIndex(this.txtNumRegistro, 0);
			this.tpBasicos.Controls.SetChildIndex(this.label7, 0);
			this.tpBasicos.Controls.SetChildIndex(this.txtNumInscripcion, 0);
			...
			this.tpBasicos.Controls.SetChildIndex(this.txtRepresentante, 0);
			this.tpBasicos.Controls.SetChildIndex(this.label11, 0);
			this.tpBasicos.Controls.SetChildIndex(this.label13, 0);
			this.tpBasicos.Controls.SetChildIndex(this.rtbActividades, 0);
			...
			this.tpBasicos.Controls.SetChildIndex(this.lblHastaTemporal, 0);
			this.tpBasicos.Controls.SetChildIndex(this.lblDesdeTemporal, 0);
			this.tpBasicos.Controls.SetChildIndex(this.dtpDesdeTemporal1, 0);
			this.tpBasicos.Controls.SetChildIndex(this.dtpHastaTemporal1, 0);
			this.tpBasicos.Controls.SetChildIndex(this.groupBox3, 0);
			this.tpBasicos.Controls.SetChildIndex(this.label28, 0);
			this.tpBasicos.Controls.SetChildIndex(this.dtpVencimientoCVO, 0);
			this.tpBasicos.Controls.SetChildIndex(this.txtCVO, 0);
			this.tpBasicos.Controls.SetChildIndex(this.label27, 0);
			this.tpBasicos.Controls.SetChildIndex(this.label30, 0);
			this.tpBasicos.Controls.SetChildIndex(this.dtpVencimientoPFMS, 0);
			this.tpBasicos.Controls.SetChildIndex(this.txtPFMS, 0);
			this.tpBasicos.Controls.SetChildIndex(this.label29, 0);
			this.tpBasicos.Controls.SetChildIndex(this.label33, 0);
			this.tpBasicos.Controls.SetChildIndex(this.dtpFechaCanon, 0);
			// 
			// tpAdmin
			// 
			this.tpAdmin.Size = new System.Drawing.Size(686, 585);
			// 
			// panelAdmin
			// 
			...
			// panelBasicos
			// 
			this.panelBasicos.Size = new System.Drawing.Size(726, 21);
			// 
			// tpAdjuntos
			// 
			this.tpAdjuntos.Size = new System.Drawing.Size(686, 585);
			// 
			// panelAdjuntos
			// 
			...
			// flvListado
			// 
			this.flvListado.Size = new System.Drawing.Size(509, 214);
			// 
			// tpCategorias
			// 
			this.tpCategorias.Controls.Add(this.gbCategorias);
			this.tpCategorias.Controls.Add(this.headerCategorias);
			this.tpCategorias.Location = new System.Drawing.Point(4, 22);
			this.tpCategorias.Name = "tpCategorias";
			this.tpCategorias.Size = new System.Drawing.Size(712, 585);
			this.tpCategorias.TabIndex = 3;
			...
			this.gbCategorias.Controls.Add(this.panel4);
			...
			this.gbCategorias.Size = new System.Drawing.Size(622, 286);
			...
			// btnNuevaCategoria
			// 
			this.btnNuevaCategoria.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			...
			this.btnNuevaCategoria.Size = new System.Drawing.Size(23, 22);
			this.btnNuevaCategoria.Text = "Nuevo Informe";
			this.btnNuevaCategoria.Click += new System.EventHandler(this.btnNuevaCategoria_Click);
			// 
			// btnEliminaCategoria
			// 
			this.btnEliminaCategoria.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			this.btnEliminaCategoria.Image = ((System.Drawing.Image)(resources.GetObject("btnEliminaCategoria.Image")));
			this.btnEliminaCategoria.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.btnEliminaCategoria.Name = "btnEliminaCategoria";
			this.btnEliminaCategoria.Size = new System.Drawing.Size(23, 22);
			this.btnEliminaCategoria.Text = "Eliminar Informe";
			this.btnEliminaCategoria.Visible = false;
			...
			this.dgvCategorias.Size = new System.Drawing.Size(613, 236);
            ...
            | System.Windows.Forms.AnchorStyles.Right)));
			this.headerCategorias.BackColor = System.Drawing.Color.DarkGray;
			...
			this.headerCategorias.Size = new System.Drawing.Size(694, 21);
			...
			// tpRegentes
			// 
			this.tpRegentes.Controls.Add(this.gbRegentes);
			this.tpRegentes.Controls.Add(this.headerRegentes);
			this.tpRegentes.Location = new System.Drawing.Point(4, 22);
			this.tpRegentes.Name = "tpRegentes";
			this.tpRegentes.Size = new System.Drawing.Size(712, 585);
			this.tpRegentes.TabIndex = 4;
			this.tpRegentes.Text = "Regentes Actuales";
			this.tpRegentes.UseVisualStyleBackColor = true;
			// 
			// gbRegentes
			// 
			this.gbRegentes.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.gbRegentes.Controls.Add(this.panel5);
			...
			this.gbRegentes.Size = new System.Drawing.Size(673, 297);
			...
			this.panel5.Size = new System.Drawing.Size(98, 25);
			this.panel5.TabIndex = 45;
			// 
			// toolStrip3
			// 
			this.toolStrip3.Items.AddRange(new System.Windows.Forms.ToolStripItem[] {
            this.btnNuevoRegente,
            this.btnEliminarRegente,
            this.btnAjustarCol});
			...
			// btnNuevoRegente
			// 
			this.btnNuevoRegente.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			this.btnNuevoRegente.Image = ((System.Drawing.Image)(resources.GetObject("btnNuevoRegente.Image")));
			this.btnNuevoRegente.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.btnNuevoRegente.Name = "btnNuevoRegente";
			this.btnNuevoRegente.Size = new System.Drawing.Size(23, 22);
			this.btnNuevoRegente.Text = "Nuevo";
			this.btnNuevoRegente.Click += new System.EventHandler(this.btnNuevoRegente_Click);
			// 
			// btnEliminarRegente
			// 
			this.btnEliminarRegente.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			this.btnEliminarRegente.Image = ((System.Drawing.Image)(resources.GetObject("btnEliminarRegente.Image")));
			this.btnEliminarRegente.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.btnEliminarRegente.Name = "btnEliminarRegente";
			this.btnEliminarRegente.Size = new System.Drawing.Size(23, 22);
			this.btnEliminarRegente.Text = "Eliminar";
			this.btnEliminarRegente.Visible = false;
			this.btnEliminarRegente.Click += new System.EventHandler(this.btnEliminarRegente_Click);
			// 
			// btnAjustarCol
			// 
			...
			this.dgvRegentes.AllowUserToDeleteRows = false;
			...
			this.dgvRegentes.Size = new System.Drawing.Size(667, 250);
			...
			this.dgvRegentes.EditingControlShowing += new System.Windows.Forms.DataGridViewEditingControlShowingEventHandler(this.dgvRegentes_EditingControlShowing);
			this.dgvRegentes.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.dgvRegentes_MouseDoubleClick);
			// 
			// colCodigoRegente
			// 
			this.colCodigoRegente.FillWeight = 76.14213F;
			this.colCodigoRegente.HeaderText = "Código";
			this.colCodigoRegente.Name = "colCodigoRegente";
			this.colCodigoRegente.Visible = false;
			// 
			// colNumeroColegiado
			// 
			...
			// colCodCategoria
			// 
			this.colCodCategoria.HeaderText = "Codigo Categoria";
			...
			// headerRegentes
			// 
			this.headerRegentes.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.headerRegentes.BackColor = System.Drawing.Color.DarkGray;
			...
			this.headerRegentes.Size = new System.Drawing.Size(694, 21);
			...
			this.label32.Size = new System.Drawing.Size(106, 14);
			this.label32.TabIndex = 0;
			this.label32.Text = "Regentes Actuales";
			// 
			// txtNumRegistro
			// 
			this.txtNumRegistro.FormatearNumero = false;
			this.txtNumRegistro.Location = new System.Drawing.Point(94, 27);
			this.txtNumRegistro.Longitud = 32767;
			this.txtNumRegistro.Multilinea = false;
			this.txtNumRegistro.Name = "txtNumRegistro";
			this.txtNumRegistro.Password = '\0';
			this.txtNumRegistro.ReadOnly = false;
			this.txtNumRegistro.Size = new System.Drawing.Size(94, 21);
			this.txtNumRegistro.TabIndex = 2;
			this.txtNumRegistro.Valor = "";
			// 
			// label7
			// 
			...
			this.label7.Text = "N° Registro:";
			// 
			// label8
			// 
			this.label8.AutoSize = true;
			this.label8.Location = new System.Drawing.Point(209, 33);
			this.label8.Name = "label8";
			this.label8.Size = new System.Drawing.Size(67, 13);
			this.label8.TabIndex = 5;
			this.label8.Text = "Núm Sesión:";
			// 
			// txtNumInscripcion
			// 
			this.txtNumInscripcion.FormatearNumero = false;
			this.txtNumInscripcion.Location = new System.Drawing.Point(282, 28);
			this.txtNumInscripcion.Longitud = 32767;
			this.txtNumInscripcion.Multilinea = false;
			this.txtNumInscripcion.Name = "txtNumInscripcion";
			this.txtNumInscripcion.Password = '\0';
			this.txtNumInscripcion.ReadOnly = false;
			this.txtNumInscripcion.Size = new System.Drawing.Size(147, 21);
			this.txtNumInscripcion.TabIndex = 4;
			this.txtNumInscripcion.Valor = "";
			// 
			// label9
			// 
			...
			this.dtpFecha.Location = new System.Drawing.Point(474, 28);
			this.dtpFecha.mostrarCheckBox = false;
			this.dtpFecha.mostrarUpDown = false;
			this.dtpFecha.Name = "dtpFecha";
			this.dtpFecha.Size = new System.Drawing.Size(82, 22);
			this.dtpFecha.TabIndex = 7;
			this.dtpFecha.Value = new System.DateTime(2019, 1, 18, 11, 31, 42, 490);
			// 
			// groupBox1
			// 
			...
			this.groupBox1.Size = new System.Drawing.Size(155, 46);
			...
			this.rbNo.Location = new System.Drawing.Point(96, 21);
			this.rbNo.Name = "rbNo";
			...
			this.rbSi.Location = new System.Drawing.Point(20, 20);
			this.rbSi.Name = "rbSi";
			...
			this.label10.Location = new System.Drawing.Point(41, 86);
			...
			// txtRepresentante
			// 
			this.txtRepresentante.FormatearNumero = false;
			this.txtRepresentante.Location = new System.Drawing.Point(282, 56);
			this.txtRepresentante.Longitud = 32767;
			this.txtRepresentante.Multilinea = false;
			this.txtRepresentante.Name = "txtRepresentante";
			this.txtRepresentante.Password = '\0';
			this.txtRepresentante.ReadOnly = false;
			this.txtRepresentante.Size = new System.Drawing.Size(276, 21);
			this.txtRepresentante.TabIndex = 11;
			this.txtRepresentante.Valor = "";
			// 
			// label13
			// 
			...
			// rtbActividades
			// 
			this.rtbActividades.Location = new System.Drawing.Point(95, 109);
			this.rtbActividades.Longitud = 2147483647;
			this.rtbActividades.Mayusculas = false;
			this.rtbActividades.Name = "rtbActividades";
			this.rtbActividades.ReadOnly = false;
			this.rtbActividades.RTF = "{\\rtf1\\ansi\\ansicpg1252\\deff0\\nouicompat\\deflang1033{\\fonttbl{\\f0\\fnil\\fcharset0 " +
    "Microsoft Sans Serif;}}\r\n{\\*\\generator Riched20 10.0.22621}\\viewkind4\\uc1 \r\n\\par" +
    "d\\f0\\fs17\\par\r\n}\r\n";
			this.rtbActividades.Size = new System.Drawing.Size(545, 66);
			this.rtbActividades.TabIndex = 16;
			// 
			// groupBox2
			// 
			...
			this.groupBox2.Location = new System.Drawing.Point(94, 181);
			...
			this.label24.Location = new System.Drawing.Point(1, 77);
			this.label24.Name = "label24";
			this.label24.Size = new System.Drawing.Size(81, 13);
			this.label24.TabIndex = 28;
			this.label24.Text = "Email Adicional:";
			// 
			// txtEmailAdicional
			// 
			this.txtEmailAdicional.FormatearNumero = false;
			this.txtEmailAdicional.Location = new System.Drawing.Point(88, 73);
			...
			this.txtEmailAdicional.TabIndex = 27;
			...
			this.txtEmail.Location = new System.Drawing.Point(88, 49);
			...
			// rtbDireccion
			// 
			this.rtbDireccion.Location = new System.Drawing.Point(95, 392);
    ...
    "d\\f0\\fs17\\par\r\n}\r\n";
			...
			this.cmbEstado.Location = new System.Drawing.Point(94, 477);
			this.cmbEstado.Name = "cmbEstado";
			this.cmbEstado.Size = new System.Drawing.Size(190, 22);
			...
			this.label19.Location = new System.Drawing.Point(45, 481);
			...
			this.txtCobrador.Location = new System.Drawing.Point(95, 449);
			...
			this.txtCobrador.Size = new System.Drawing.Size(94, 21);
			this.txtCobrador.TabIndex = 44;
			...
			this.label20.Location = new System.Drawing.Point(36, 452);
			...
			this.txtCobradorNombre.Location = new System.Drawing.Point(195, 449);
			...
			this.txtSesionCierre.Size = new System.Drawing.Size(190, 21);
			this.txtSesionCierre.TabIndex = 47;
			this.txtSesionCierre.Valor = "";
			// 
			// tpInformes
			// 
			this.tpInformes.Controls.Add(this.headerInformes);
			this.tpInformes.Controls.Add(this.gbInformes);
			this.tpInformes.Location = new System.Drawing.Point(4, 22);
			this.tpInformes.Name = "tpInformes";
			this.tpInformes.Size = new System.Drawing.Size(712, 585);
			this.tpInformes.TabIndex = 5;
			this.tpInformes.Text = "Informes";
			this.tpInformes.UseVisualStyleBackColor = true;
			// 
			// headerInformes
			// 
			this.headerInformes.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.headerInformes.BackColor = System.Drawing.Color.DarkGray;
			...
			this.headerInformes.Size = new System.Drawing.Size(694, 21);
			...
			this.label21.Text = "Informes";
			// 
			// gbInformes
			// 
			this.gbInformes.Anchor = ((System.Windows.Forms.AnchorStyles)((((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom) 
            | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.gbInformes.Controls.Add(this.panel6);
			...
			this.gbInformes.Size = new System.Drawing.Size(653, 308);
			...
			this.panel6.Size = new System.Drawing.Size(102, 28);
			...
			this.toolStrip4.Size = new System.Drawing.Size(102, 25);
			...
			// btnAjustarInf
			// 
			this.btnAjustarInf.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			this.btnAjustarInf.Image = ((System.Drawing.Image)(resources.GetObject("btnAjustarInf.Image")));
			this.btnAjustarInf.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.btnAjustarInf.Name = "btnAjustarInf";
			this.btnAjustarInf.Size = new System.Drawing.Size(23, 22);
			this.btnAjustarInf.Text = "Ajustar Tamaño Columnas";
			this.btnAjustarInf.Click += new System.EventHandler(this.btnAjustarInf_Click);
			// 
			// dgvInformes
			// 
            ...
            this.colIdInforme,
            this.colNumeroColeInformes,
            this.colNumCole,
            this.colNombreColeInformes,
            this.colFechaInf,
			...
			this.dgvInformes.Size = new System.Drawing.Size(644, 257);
			...
			this.dgvInformes.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.dgvInformes_MouseDoubleClick);
			// 
			// colIdInforme
			// 
			...
			// 
			// colNumeroColeInformes
			// 
			this.colNumeroColeInformes.HeaderText = "Numero";
			this.colNumeroColeInformes.Name = "colNumeroColeInformes";
			this.colNumeroColeInformes.Visible = false;
			// 
			// colNumCole
			// 
			this.colNumCole.HeaderText = "Numero Colegiado";
			this.colNumCole.Name = "colNumCole";
			// 
			// colNombreColeInformes
			// 
			this.colNombreColeInformes.HeaderText = "Nombre";
			this.colNombreColeInformes.Name = "colNombreColeInformes";
			// 
			// colFechaInf
			// 
			...
			this.txtCedulaJuridica.Location = new System.Drawing.Point(95, 54);
			...
			this.txtCedulaJuridica.TabIndex = 49;
			this.txtCedulaJuridica.Valor = "";
			// 
			// lblHastaTemporal
			// 
			this.lblHastaTemporal.AutoSize = true;
			this.lblHastaTemporal.Location = new System.Drawing.Point(506, 481);
			this.lblHastaTemporal.Name = "lblHastaTemporal";
			this.lblHastaTemporal.Size = new System.Drawing.Size(38, 13);
			this.lblHastaTemporal.TabIndex = 51;
			this.lblHastaTemporal.Text = "Hasta:";
			this.lblHastaTemporal.Visible = false;
			// 
			// lblDesdeTemporal
			// 
			this.lblDesdeTemporal.AutoSize = true;
			this.lblDesdeTemporal.Location = new System.Drawing.Point(351, 481);
			this.lblDesdeTemporal.Name = "lblDesdeTemporal";
			this.lblDesdeTemporal.Size = new System.Drawing.Size(41, 13);
			this.lblDesdeTemporal.TabIndex = 53;
			this.lblDesdeTemporal.Text = "Desde:";
			this.lblDesdeTemporal.Visible = false;
			// 
			// dtpDesdeTemporal1
			// 
			this.dtpDesdeTemporal1.Format = System.Windows.Forms.DateTimePickerFormat.Short;
			this.dtpDesdeTemporal1.Location = new System.Drawing.Point(398, 478);
			this.dtpDesdeTemporal1.Name = "dtpDesdeTemporal1";
			this.dtpDesdeTemporal1.Size = new System.Drawing.Size(81, 20);
			this.dtpDesdeTemporal1.TabIndex = 55;
			this.dtpDesdeTemporal1.Visible = false;
			this.dtpDesdeTemporal1.ValueChanged += new System.EventHandler(this.dtpDesdeTemporal1_ValueChanged);
			// 
			// dtpHastaTemporal1
			// 
			this.dtpHastaTemporal1.Format = System.Windows.Forms.DateTimePickerFormat.Short;
			this.dtpHastaTemporal1.Location = new System.Drawing.Point(548, 478);
			this.dtpHastaTemporal1.Name = "dtpHastaTemporal1";
			this.dtpHastaTemporal1.Size = new System.Drawing.Size(81, 20);
			this.dtpHastaTemporal1.TabIndex = 56;
			this.dtpHastaTemporal1.Visible = false;
			this.dtpHastaTemporal1.ValueChanged += new System.EventHandler(this.dtpHastaTemporal1_ValueChanged);
			// 
			// tpVisitasF
			// 
			this.tpVisitasF.Controls.Add(this.headerVisitas);
			this.tpVisitasF.Controls.Add(this.gbVisitas);
			this.tpVisitasF.Location = new System.Drawing.Point(4, 22);
			this.tpVisitasF.Name = "tpVisitasF";
			this.tpVisitasF.Size = new System.Drawing.Size(712, 585);
			this.tpVisitasF.TabIndex = 6;
			this.tpVisitasF.Text = "Visitas Fiscales";
			this.tpVisitasF.UseVisualStyleBackColor = true;
			// 
			// headerVisitas
			// 
			this.headerVisitas.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left) 
            | System.Windows.Forms.AnchorStyles.Right)));
			this.headerVisitas.BackColor = System.Drawing.Color.DarkGray;
			...
			this.headerVisitas.Size = new System.Drawing.Size(694, 21);
			...
			this.label22.Text = "Visitas Fiscales";
			// 
			// gbVisitas
			// 
			this.gbVisitas.Controls.Add(this.panel7);
			this.gbVisitas.Controls.Add(this.dgvVisitasFisc);
			this.gbVisitas.Location = new System.Drawing.Point(8, 54);
			this.gbVisitas.Name = "gbVisitas";
			this.gbVisitas.Size = new System.Drawing.Size(670, 511);
			this.gbVisitas.TabIndex = 44;
			this.gbVisitas.TabStop = false;
			this.gbVisitas.Text = "Visitas Fiscalía";
			// 
			// panel7
			// 
			this.panel7.Controls.Add(this.toolStrip6);
			this.panel7.Location = new System.Drawing.Point(6, 15);
			this.panel7.Name = "panel7";
			this.panel7.Size = new System.Drawing.Size(90, 28);
			...
			this.toolStrip6.Size = new System.Drawing.Size(90, 25);
			...
			// btnAjustarVist
			// 
			this.btnAjustarVist.DisplayStyle = System.Windows.Forms.ToolStripItemDisplayStyle.Image;
			this.btnAjustarVist.Image = ((System.Drawing.Image)(resources.GetObject("btnAjustarVist.Image")));
			this.btnAjustarVist.ImageTransparentColor = System.Drawing.Color.Magenta;
			this.btnAjustarVist.Name = "btnAjustarVist";
			this.btnAjustarVist.Size = new System.Drawing.Size(23, 22);
			this.btnAjustarVist.Text = "Ajustar Tamaño Columnas";
			this.btnAjustarVist.Click += new System.EventHandler(this.btnAjustarVist_Click);
			// 
			// dgvVisitasFisc
			// 
            ...
            this.colIdVisitas,
            this.colIdColeVisitas,
            this.colNumeroColeVisitas,
            this.colNombreColeVisitas,
            this.colFechaFisc,
			...
			this.dgvVisitasFisc.Size = new System.Drawing.Size(661, 461);
			...
			this.dgvVisitasFisc.MouseDoubleClick += new System.Windows.Forms.MouseEventHandler(this.dgvVisitasFisc_MouseDoubleClick);
			// 
			// colIdVisitas
			// 
			...
			// colIdColeVisitas
			// 
			this.colIdColeVisitas.HeaderText = "IdColegiado";
			this.colIdColeVisitas.Name = "colIdColeVisitas";
			this.colIdColeVisitas.Visible = false;
			// 
			// colNumeroColeVisitas
			// 
			this.colNumeroColeVisitas.HeaderText = "Número Colegiado";
			this.colNumeroColeVisitas.Name = "colNumeroColeVisitas";
			// 
			// colNombreColeVisitas
			// 
			this.colNombreColeVisitas.HeaderText = "Nombre";
			this.colNombreColeVisitas.Name = "colNombreColeVisitas";
			// 
			// colFechaFisc
			// 
			...
			this.groupBox3.Controls.Add(this.txtCoordenadaN);
			this.groupBox3.Controls.Add(this.txtCoordenadaW);
			...
			this.label25.Location = new System.Drawing.Point(330, 21);
			this.label25.Name = "label25";
			this.label25.Size = new System.Drawing.Size(79, 13);
			this.label25.TabIndex = 278;
			this.label25.Text = "Coordenada N:";
			// 
			// label26
			// 
			...
			this.label26.Text = "Coordenada W:";
			// 
			// txtCoordenadaN
			// 
			this.txtCoordenadaN.FormatearNumero = false;
			this.txtCoordenadaN.Location = new System.Drawing.Point(415, 17);
			this.txtCoordenadaN.Longitud = 50;
			this.txtCoordenadaN.Multilinea = false;
			this.txtCoordenadaN.Name = "txtCoordenadaN";
			this.txtCoordenadaN.Password = '\0';
			this.txtCoordenadaN.ReadOnly = false;
			this.txtCoordenadaN.Size = new System.Drawing.Size(102, 21);
			this.txtCoordenadaN.TabIndex = 276;
			this.txtCoordenadaN.Valor = "";
			// 
			// txtCoordenadaW
			// 
			this.txtCoordenadaW.FormatearNumero = false;
			this.txtCoordenadaW.Location = new System.Drawing.Point(415, 44);
			this.txtCoordenadaW.Longitud = 50;
			this.txtCoordenadaW.Multilinea = false;
			this.txtCoordenadaW.Name = "txtCoordenadaW";
			this.txtCoordenadaW.Password = '\0';
			this.txtCoordenadaW.ReadOnly = false;
			this.txtCoordenadaW.Size = new System.Drawing.Size(102, 21);
			this.txtCoordenadaW.TabIndex = 277;
			this.txtCoordenadaW.Valor = "";
			// 
			// txtCantonNombreF
			// 
			this.txtCantonNombreF.FormatearNumero = false;
			this.txtCantonNombreF.Location = new System.Drawing.Point(136, 44);
			...
			this.txtProvinciaNombreF.Location = new System.Drawing.Point(136, 17);
			...
			this.label44.Location = new System.Drawing.Point(28, 48);
			...
			this.label45.Location = new System.Drawing.Point(30, 76);
			...
			this.txtProvincia.Location = new System.Drawing.Point(78, 17);
			...
			this.txtDistritoNombreF.Location = new System.Drawing.Point(136, 71);
			...
			this.txtDistrito.Location = new System.Drawing.Point(78, 71);
			...
			this.txtCanton.Location = new System.Drawing.Point(78, 44);
			...
			this.label27.Location = new System.Drawing.Point(56, 535);
			this.label27.Name = "label27";
			this.label27.Size = new System.Drawing.Size(32, 13);
			this.label27.TabIndex = 61;
			this.label27.Text = "CVO:";
			// 
			// txtCVO
			// 
			this.txtCVO.FormatearNumero = false;
			this.txtCVO.Location = new System.Drawing.Point(94, 531);
			this.txtCVO.Longitud = 32767;
			this.txtCVO.Multilinea = false;
			this.txtCVO.Name = "txtCVO";
			this.txtCVO.Password = '\0';
			this.txtCVO.ReadOnly = false;
			this.txtCVO.Size = new System.Drawing.Size(190, 21);
			this.txtCVO.TabIndex = 60;
			this.txtCVO.Valor = "";
			// 
			// dtpVencimientoCVO
			// 
			this.dtpVencimientoCVO.Checked = false;
			this.dtpVencimientoCVO.Location = new System.Drawing.Point(525, 533);
			this.dtpVencimientoCVO.mostrarCheckBox = true;
			this.dtpVencimientoCVO.mostrarUpDown = false;
			this.dtpVencimientoCVO.Name = "dtpVencimientoCVO";
			this.dtpVencimientoCVO.Size = new System.Drawing.Size(104, 22);
			this.dtpVencimientoCVO.TabIndex = 59;
			this.dtpVencimientoCVO.Value = new System.DateTime(2019, 1, 18, 11, 31, 42, 490);
			// 
			// label28
			// 
			this.label28.AutoSize = true;
			this.label28.Location = new System.Drawing.Point(426, 537);
			this.label28.Name = "label28";
			this.label28.Size = new System.Drawing.Size(93, 13);
			this.label28.TabIndex = 58;
			this.label28.Text = "Vencimiento CVO:";
			// 
			// label29
			// 
			this.label29.AutoSize = true;
			this.label29.Location = new System.Drawing.Point(49, 563);
			this.label29.Name = "label29";
			this.label29.Size = new System.Drawing.Size(39, 13);
			this.label29.TabIndex = 65;
			this.label29.Text = "PFMS:";
			// 
			// txtPFMS
			// 
			this.txtPFMS.FormatearNumero = false;
			this.txtPFMS.Location = new System.Drawing.Point(94, 558);
			this.txtPFMS.Longitud = 32767;
			this.txtPFMS.Multilinea = false;
			this.txtPFMS.Name = "txtPFMS";
			this.txtPFMS.Password = '\0';
			this.txtPFMS.ReadOnly = false;
			this.txtPFMS.Size = new System.Drawing.Size(190, 21);
			this.txtPFMS.TabIndex = 64;
			this.txtPFMS.Valor = "";
			// 
			// dtpVencimientoPFMS
			// 
			this.dtpVencimientoPFMS.Checked = false;
			this.dtpVencimientoPFMS.Location = new System.Drawing.Point(526, 559);
			this.dtpVencimientoPFMS.mostrarCheckBox = true;
			this.dtpVencimientoPFMS.mostrarUpDown = false;
			this.dtpVencimientoPFMS.Name = "dtpVencimientoPFMS";
			this.dtpVencimientoPFMS.Size = new System.Drawing.Size(104, 22);
			this.dtpVencimientoPFMS.TabIndex = 63;
			this.dtpVencimientoPFMS.Value = new System.DateTime(2019, 1, 18, 11, 31, 42, 490);
			// 
			// label30
			// 
			this.label30.AutoSize = true;
			this.label30.Location = new System.Drawing.Point(419, 563);
			this.label30.Name = "label30";
			this.label30.Size = new System.Drawing.Size(100, 13);
			this.label30.TabIndex = 62;
			this.label30.Text = "Vencimiento PFMS:";
			// 
			// tpHorarios
			// 
			this.tpHorarios.Controls.Add(this.groupBox4);
			this.tpHorarios.Controls.Add(this.panel2);
			this.tpHorarios.Location = new System.Drawing.Point(4, 22);
			this.tpHorarios.Name = "tpHorarios";
			this.tpHorarios.Size = new System.Drawing.Size(712, 585);
			this.tpHorarios.TabIndex = 1;
			...
			this.groupBox4.Controls.Add(this.dgvHorarios);
			this.groupBox4.Location = new System.Drawing.Point(45, 75);
			this.groupBox4.Name = "groupBox4";
			this.groupBox4.Size = new System.Drawing.Size(588, 480);
			...
			this.dgvHorarios.Size = new System.Drawing.Size(579, 430);
			...
			// dtpFechaCanon
			// 
			this.dtpFechaCanon.Format = System.Windows.Forms.DateTimePickerFormat.Short;
			this.dtpFechaCanon.Location = new System.Drawing.Point(643, 85);
			this.dtpFechaCanon.Name = "dtpFechaCanon";
			this.dtpFechaCanon.Size = new System.Drawing.Size(81, 20);
			this.dtpFechaCanon.TabIndex = 67;
			this.dtpFechaCanon.Visible = false;
			// 
			// label33
			// 
			this.label33.AutoSize = true;
			this.label33.Location = new System.Drawing.Point(566, 88);
			...
			this.ClientSize = new System.Drawing.Size(740, 702);
			this.Icon = ((System.Drawing.Icon)(resources.GetObject("$this.Icon")));
			this.Name = "frmEstablecimientosEdicion";
			this.Text = "Establecimientos";
			this.Load += new System.EventHandler(this.frmEstablecimientosEdicion_Load);
			...
			this.headerCategorias.ResumeLayout(false);
			this.headerCategorias.PerformLayout();
			this.tpRegentes.ResumeLayout(false);
			this.gbRegentes.ResumeLayout(false);
			this.panel5.ResumeLayout(false);
			this.panel5.PerformLayout();
			this.toolStrip3.ResumeLayout(false);
			this.toolStrip3.PerformLayout();
			((System.ComponentModel.ISupportInitialize)(this.dgvRegentes)).EndInit();
			this.headerRegentes.ResumeLayout(false);
			this.headerRegentes.PerformLayout();
			this.groupBox1.ResumeLayout(false);
			this.groupBox2.ResumeLayout(false);
			this.groupBox2.PerformLayout();
			this.tpInformes.ResumeLayout(false);
			this.headerInformes.ResumeLayout(false);
			this.headerInformes.PerformLayout();
			...
			this.tpVisitasF.ResumeLayout(false);
			this.headerVisitas.ResumeLayout(false);
			this.headerVisitas.PerformLayout();
        ...
        private System.Windows.Forms.TabPage tpRegentes;
        private System.Windows.Forms.Panel headerCategorias;
        private System.Windows.Forms.Label label31;
        private System.Windows.Forms.Panel headerRegentes;
        private System.Windows.Forms.Label label32;
        private System.Windows.Forms.DataGridView dgvRegentes;
        private System.Windows.Forms.GroupBox gbRegentes;
        private Framework.UserControls.dtpSaseg dtpFecha;
        private System.Windows.Forms.Label label9;
        private System.Windows.Forms.Label label8;
        private Framework.UserControls.txtNormal txtNumInscripcion;
        private System.Windows.Forms.Label label7;
        private Framework.UserControls.txtNormal txtNumRegistro;
        ...
        private Framework.UserControls.txtNormal txtRepresentante;
        private Framework.UserControls.rtbSaseg rtbActividades;
        ...
        private System.Windows.Forms.ToolStripButton btnEliminarRegente;
        private System.Windows.Forms.ToolStripButton btnNuevoRegente;
        ...
        private System.Windows.Forms.Label lblDesdeTemporal;
        private System.Windows.Forms.Label lblHastaTemporal;
        private System.Windows.Forms.DateTimePicker dtpDesdeTemporal1;
        private System.Windows.Forms.DateTimePicker dtpHastaTemporal1;
        private System.Windows.Forms.DataGridViewTextBoxColumn colIdInforme;
        private System.Windows.Forms.DataGridViewTextBoxColumn colNumeroColeInformes;
        private System.Windows.Forms.DataGridViewTextBoxColumn colNumCole;
        private System.Windows.Forms.DataGridViewTextBoxColumn colNombreColeInformes;
        ...
        private System.Windows.Forms.ToolStripButton btnAjustarInf;
        private System.Windows.Forms.TabPage tpVisitasF;
        ...
        private System.Windows.Forms.ToolStripButton btnAjustarVist;
        private System.Windows.Forms.DataGridViewTextBoxColumn colIdVisitas;
        private System.Windows.Forms.DataGridViewTextBoxColumn colIdColeVisitas;
        private System.Windows.Forms.DataGridViewTextBoxColumn colNumeroColeVisitas;
        private System.Windows.Forms.DataGridViewTextBoxColumn colNombreColeVisitas;
        ...
        private System.Windows.Forms.DataGridViewTextBoxColumn colCodigoRegente;
        ...
        private System.Windows.Forms.Panel headerInformes;
        private System.Windows.Forms.Label label21;
        private System.Windows.Forms.Panel headerVisitas;
        private System.Windows.Forms.Label label22;
        private System.Windows.Forms.GroupBox groupBox3;
        private System.Windows.Forms.Label label25;
        private System.Windows.Forms.Label label26;
        private Framework.UserControls.txtNormal txtCoordenadaN;
        private Framework.UserControls.txtNormal txtCoordenadaW;
		...
		private Framework.UserControls.txtNormal txtPFMS;
		private Framework.UserControls.dtpSaseg dtpVencimientoPFMS;
		private System.Windows.Forms.Label label30;
		private System.Windows.Forms.Label label27;
		private Framework.UserControls.txtNormal txtCVO;
		private Framework.UserControls.dtpSaseg dtpVencimientoCVO;
