...
namespace Framework
{
    public class Conexion
    {
        ...
        public Conexion(string usuario,string contraseña,string compañia)
        {
        ...
        public Conexion(string usuario, string xUsuario, string contraseña, string compañia)
        {
            this.usuario = usuario;
            this.contraseña = contraseña;
            this.compañia = compañia;
        ...
        {
            return conexion = new SqlConnection("Data Source=" + servidor + "; Initial Catalog=" + baseDatos + "; user id=" + usuario + ";password=" + contraseña);
        ...
        public object ExecuteEscalar(string sentencia, SqlCommand command)
        {
            object dato;
            this.comando = null;
            try
