...
//            System.Diagnostics.Debug.WriteLine(String.Format("Changed hot item: {0}", args));
        ...
        /// <param name="columnIndex"></param>
        /// <param name="style"></param>
        public virtual void ApplyCellStyle(OLVListItem olvi, int columnIndex, IItemStyle style) {
            if (style == null)
                return;
        ...
        public virtual void cambiarFondoCelda(OLVListItem olvi, int columnIndex,string color)
        {
