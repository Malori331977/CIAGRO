...
namespace BrightIdeasSoftware {
    ...
    public class FilterMenuBuilder {
        ...
        /// </summary>
        static public string APPLY_LABEL = "Aplicar";

        /// <summary>
        /// Gets or sets the string that labels the Clear All menu item.
        /// Exposed so it can be localized.
        /// </summary>
        static public string CLEAR_ALL_FILTERS_LABEL = "Eliminar todos los filtros";

        /// <summary>
        /// Gets or sets the string that labels the Filtering menu as a whole..
        /// Exposed so it can be localized.
        /// </summary>
        static public string FILTERING_LABEL = "Filtrar";
        ...
        /// Exposed so it can be localized.
        /// </summary>
        static public string SELECT_ALL_LABEL = "Seleccionar todos";
